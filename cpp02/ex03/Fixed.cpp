...
/*   Updated: 2023/03/08 13:50:47 by bperron          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int Fixed::getRawBits() const { return nb; }

void Fixed::setRawBits(int const raw) { nb = raw; }

float Fixed::toFloat() const { return ((float)this->nb / 256); }

int Fixed::toInt() const { return (this->nb >> fb); }
