...
/*   Updated: 2022/10/25 11:03:02 by bperron          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Account::makeDeposit(int deposit){
	...
	";deposit:" << deposit << ";amount:" << this->_amount << ";deposits:" << this->_nbDeposits << std::endl;
}
...
void	Account::_displayTimestamp(){
	...
	std::cout << "[" <<time2->tm_year + 1900 << std::setw(2) << std::setfill('0') << time2->tm_mon << 
		std::setw(2) << std::setfill('0') << time2->tm_mday << "_" << std::setw(2) << std::setfill('0') << time2->tm_hour << 
		std::setw(2) << std::setfill('0') << time2->tm_min << std::setw(2) << std::setfill('0') << time2->tm_sec << "]";
}
